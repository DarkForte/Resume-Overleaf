...
\section{Projects}
  \begin{itemize}[leftmargin=*, itemsep=5pt, label={}]
    ...
    \resumeSubheading{Real-time Online Game: "Bomber Man Online"}{04/2015}{Beijing University of Technology | C++, Direct2D, IOCP, STL, Concurrency Control}
        \resumeItemListStart
            \resumeItem {Designed and implemented the client-server architecture and the game core from scratch.}
            \resumeItem {Implemented lockstep multiplayer synchronization model with semaphores and daemon threads.}
        \resumeItemListEnd
